...
class PumaWidget extends StatefulWidget {
  const PumaWidget({super.key});

  @override
  State<PumaWidget> createState() => _PumaWidgetState();
}

class _PumaWidgetState extends State<PumaWidget> {
  int activeIndex = 0;
      ...
      children: [
          ...
          child: CarouselSlider(
            ...
            items: [
              Container(
                ...
                child: BannerWidget(
                    imageUrl: "assets/images/puma/carousel/banner1.png"),
              ),
              BannerWidget(imageUrl: "assets/images/puma/carousel/banner2.png"),
              BannerWidget(
                  imageUrl: "assets/images/puma/carousel/banner3.png",
                  boxfitData: BoxFit.fitHeight),
            ],
          ),
        ),
        SizedBox(
        ...
        GridView.builder(
          ...
          itemBuilder: (context, index) {
            ShoeModel model = PUMAStocks[index];
            return ShoeTile(
              pdtName: model.Name,
